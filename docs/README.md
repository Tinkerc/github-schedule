...
- **Tech Industry Insights**: Aggregates data from Hacker News, Product Hunt, Dev.to, and generates AI-powered industry briefs
- **AI-Powered Analysis**: Analyzes trending data using Volcengine Doubao model
- **WeChat Work Integration**: Sends daily notifications to Enterprise WeChat
- **Notion Sync**: Optional sync to Notion for mobile access (sub-page or database mode)
...
- [Sub-Page Configuration](docs/reference/notion-subpage-config.md) - Detailed setup guide for both modes
- [Migration Guide](docs/guides/migration/notion-migration-guide.md) - Migrating from old config file format

See [Documentation](#documentation) below for more resources.
...
1. `hackernews` (PRIORITY: 15) - Fetches Top 30 stories from Hacker News
2. `producthunt` (PRIORITY: 16) - Scrapes Top 20 products from Product Hunt
3. `techblogs` (PRIORITY: 17) - Fetches trending articles from Dev.to
4. `github_trending` (PRIORITY: 20) - Scrapes GitHub trending repositories and saves as markdown
5. `trending_ai` (PRIORITY: 30) - Analyzes trending data using AI and generates insights
6. `tech_insights` (PRIORITY: 40) - Aggregates data sources and generates AI-powered tech industry brief
7. `wecom` (Notifier) - Posts news to WeChat Work webhook
...
├── hackernews/                 # Hacker News Top 30 stories (YYYY-MM-DD.json)
├── producthunt/                # Product Hunt Top 20 products (YYYY-MM-DD.json)
├── techblogs/                  # Dev.to trending articles (YYYY-MM-DD.json)
├── github-trending/            # GitHub trending data organized by year
│   └── {year}/                 # Yearly subdirectories
│       └── {date}.md           # Raw trending data
├── tech-insights/              # AI-generated tech industry briefs (YYYY-MM-DD.md)
...
The `docs/` folder contains comprehensive documentation organized by type:

### Folder Structure

```
docs/
├── designs/              # Design documents and architecture
│   ├── notion/          # Notion integration designs
│   ├── task-framework/  # Task framework design
│   ├── tech-insights/   # Tech insights system design
│   └── trending-ai/     # Trending AI optimization design
├── plans/               # Implementation plans (organized by topic)
│   ├── notion/          # Notion implementation plans
│   ├── task-framework/  # Task framework implementation
│   ├── tech-insights/   # Tech insights implementation
│   └── trending-ai/     # Trending AI optimization plans
...
├── reports/             # Debug and success reports
└── reference/           # Configuration and verification docs
```

### Key Documents

**Guides:**
- [Setup Guide](docs/guides/setup/) - Initial setup instructions
- [Migration Guides](docs/guides/migration/) - Migration documentation
- [Execution Guide](docs/guides/execution/EXECUTION_GUIDE.md) - Running the system

**Design Documents:**
- [Task Framework Design](docs/designs/task-framework/) - Architecture of the task system
- [Tech Insights Design](docs/designs/tech-insights/) - AI-powered insights system
- [Notion Integration Design](docs/designs/notion/) - Notion sync architecture

**Standards:**
- [Testing Standards](docs/standards/testing/TESTING_STANDARDS.md) - Testing guidelines and best practices

**Reference:**
- [Notion Configuration](docs/reference/notion-subpage-config.md) - Notion setup reference
- [Notion Verification](docs/reference/notion-verification.md) - Verification procedures

**Reports:**
- [Notion Success Report](docs/reports/notion-integration-success-report.md) - Implementation results
- [Debug Reports](docs/reports/notion-debug-report.md) - Troubleshooting information
